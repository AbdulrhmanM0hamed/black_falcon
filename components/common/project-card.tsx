  ...
  return (
    <Reveal delay={delay}>
      <Link
        ...
        className="group flex h-full flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-[0_18px_52px_rgba(0,0,0,0.16)] transition-transform duration-300 hover:-translate-y-1 md:min-h-[30rem]"
      >
